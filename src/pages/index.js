    ...
    return(
      <div className={styles.header}>
        ...
        <div className={styles.headerContainer}>
          <button onClick={this.appearIt} className={styles.menue} style={{display:this.state.display,fontSize:28}}>:::</button>
          <h1>We Come With More Than  Shoots!</h1>
        </div>
      </div>
    )
  }
  ...
  render(){
   return(
     <div className={styles.div}>
        ...
        {this.state.imgArr.map(e=>{
          return(
            <div className={styles.container}>
              <img src={e.url} alt={''} className={styles.imgs}></img>
            </div>
          )
        })
      }
