  ...
  render(){
    return(
      <div className={styles.header}>
        ...
        <Link to="/slideShow/" className={styles.sideLinks}>SlideShow</Link>
        </div>
...
class Inputs extends React.Component{
  ...
  handleChangeDiscription = (discription)=>{
    this.setState({
      discription: discription.target.value
    })
  }
      ...
      <div className={styles.div}>
        <div className={styles.formContainer}>
          <form onSubmit={this.handleSubmit}>
            <input className={styles.input} type='text' placeholder='Title' onChange={this.handleChangeTitle}></input>
            <input className={styles.input} type='date' placeholder='Date' onChange={this.handleChangeDate}></input>
            <input className={styles.input} type='text' placeholder='Category' onChange={this.handleChangeCategory}></input>
            <input className={styles.input} type='text' placeholder='Url' onChange={this.handleChangeUrl}></input>
            <textarea className={styles.input}  placeholder='Discription' onChange={this.handleChangeDiscription}></textarea>
